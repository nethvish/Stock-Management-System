<%
	...
	} //session is a jsp implicit object.these objects are created by the web container that are available to all the jsp pages.
%>
...
<body id="page-top">
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav ms-auto">
					...
					<li class="nav-item mx-0 mx-lg-1"><a
						class="nav-link py-3 px-0 px-lg-3 rounded" href="stock-form.jsp">Stocks</a></li>	
					<li class="nav-item mx-0 mx-lg-1"><a
	...
	<header class="masthead bg-info text-white text-center">
		<div class="container d-flex align-items-center flex-column">
			<!-- Masthead Heading-->
			<h1 class="masthead-heading text-uppercase mb-0">Welcome To <br><br> Stock Management System</h1>
			<!-- Icon Divider-->
	...
	<section class="page-section portfolio" id="portfolio">
		<div class="container">
			...
			<h2
				class="page-section-heading text-center text-uppercase text-secondary mb-0">Stocks</h2>
			<!-- Icon Divider-->
	...
	<section class="page-section bg-success text-white mb-0" id="about">
		<div class="container">
			...
			<div class="row">
				<div>
					<p class="lead">Stock management is the function of understanding the stock mix of a company and the different demands on that stock. 
					<br> Stock management system is important for every other business enterprise. This systems can also be used for small businesses</p>
				</div>
				<div>
					<p class="lead">Inventory is a major asset that represents tied up capital; managing stock effectively therefore enables a business to free up capital.
					 A best inventory management strategy improves the accuracy of inventory orders.</p>
				</div>
			</div>
		</div>
	</section>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-4 mb-5 mb-lg-0">
					...
					<p class="lead mb-0">
						Stock management <br /> Malabe, SLIIT 
					</p>
				</div>
				<!-- Footer Social Icons-->
				<div class="col-lg-4 mb-5 mb-lg-0">
				...
				<!-- Footer About Text-->
				<div class="col-lg-4">
					<h4 class="text-uppercase mb-4">About Stock Management</h4>
					<p class="lead mb-0">
	...
	<div class="copyright py-4 text-center text-white">
		<div class="container">
			<small>Copyright &copy; Stock Management System</small>
		</div>
	</div>
